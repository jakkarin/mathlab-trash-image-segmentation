...
% canny, sobel, prewitt, roberts supported
ARG_METHOD = 'canny';

[rgb_r, rgb_g, rgb_b] = segment_utils.multi_edge_detection(ARG_METHOD, rgb_r, rgb_g, rgb_b);
[hsv_h, hsv_s, hsv_v] = segment_utils.multi_edge_detection(ARG_METHOD, hsv_h, hsv_s, hsv_v);
[ycbcr_y, ycbcr_cb, ycbcr_cr] = segment_utils.multi_edge_detection(ARG_METHOD, ycbcr_y, ycbcr_cb, ycbcr_cr);
